...
- `products/brain-health/skills/activity-2-3-sudoku.md`
- `products/brain-health/skills/activity-3-1-logic-puzzles.md`
- `products/brain-health/skills/activity-3-2-crossnumber.md`
...
3. For activities 2.1, 2.2, 2.3, and 3.2: run Phase 1 (generate lists/clues) then Phase 2 (generate grids via script)
...
workspace/[THEME]/activities/
  ...
  3-2-crossnumber-clues.md
  3-2-crossnumber-grids/
