...
- `max_competitors` — maximum number of competitors to study (passed from build-agent)
...
| product_type    | skill                                                                    |
|-----------------|--------------------------------------------------------------------------|
| `google-sheets` | `pipeline/03-build/skills/study/reverse-engineer/google-sheets.md` |
| `notion`        | `pipeline/03-build/skills/study/reverse-engineer/notion.md`        |
| `canva`         | `pipeline/03-build/skills/study/reverse-engineer/canva.md`         |
